...
scatterPlot<- scatterPlot+
  ...
  geom_mark_ellipse(aes(filter = field == 'Astronomy', label = 'Astronomy',
                                  description = 'Low familiarity with Open Science but high trust in the field ')) +
  geom_mark_ellipse(aes(filter = field == 'Medicine', label = 'Medicine',
                                  description = 'Low familiarity with Open Science and low trust in the field ')) +
...
Combine altogether. `plot_layout(guides = 'collect')` is needed to align the legends.
